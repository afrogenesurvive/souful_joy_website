                ...
                <Row className="detailViewer_subRow xRow">
                  ...
                  {props.data.page === 'team' &&
                    props.data.data === 'team_1_kwayera' && (
                      <Col className="detail_content_Col">
                  ...
                  {props.data.page === 'retreat' &&
                    props.data.data === 'location_1' && (
                      <Row className="detail_content_row">
                        <Image src={location_1} className="detailViewer_Img locationDetailImg" fluid/>
                      </Row>
                  )}
                  {props.data.page === 'retreat' &&
                    props.data.data === 'location_2' && (
                      <Row className="detail_content_row">
                        <Image src={location_2} className="detailViewer_Img locationDetailImg" fluid/>
                      </Row>
                  )}
                  {props.data.page === 'retreat' &&
                    props.data.data === 'location_3' && (
                      <Row className="detail_content_row">
                        <Image src={location_3} className="detailViewer_Img locationDetailImg" fluid/>
                      </Row>
                  )}
                  {props.data.page === 'retreat' &&
                    props.data.data === 'location_4' && (
                      <Row className="detail_content_row">
                        <Image src={location_4} className="detailViewer_Img locationDetailImg" fluid/>
                      </Row>
                  )}
                  {props.data.page === 'retreat' &&
                    props.data.data === 'location_5' && (
                      <Row className="detail_content_row">
                        <Image src={location_5} className="detailViewer_Img locationDetailImg" fluid/>
                      </Row>
                  )}
                  {props.data.page === 'retreat' &&
                    props.data.data === 'location_6' && (
                      <Row className="detail_content_row">
                        <Image src={location_6} className="detailViewer_Img locationDetailImg" fluid/>
                      </Row>
                  )}
